...
/**
 * Provides an interface defining si_stat Storage.
 *
 * Stores the views per day, total views and timestamp of last view
 * for entities.
 */
interface StatStorageInterface {
   ...
   */
  public function fetchViews($entity_type, $entity_id);
   ...
   *
   * @return \Drupal\si_stat\StatViewsResult|false
   ...
   *   - 'yearcount' The number of views during the year.
   *   - 'monthcount' The number of views during the month.
   *   - 'weekcount' The number of views during the week.
   *   - 'daycount' The number of views during the day.
