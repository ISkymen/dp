...
$base_url = 'http://dp.dev.loc:35487';


$settings['install_profile'] = 'standard';

$settings['file_public_path'] = 'files';
$settings['file_public_base_url'] = $base_url . '/files';
...
// $config['language.negotiation']['url']['domains']['ru'] = 'dp.dev.loc';
...
$config['stage_file_proxy.settings']['origin'] = 'https://donpress.com';
